...
public class Dots extends Application {
  ...
  // ---------------------------------------------------------------------------
  // Displays a scene on which the user can add colored dots with mouse clicks.
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  // Process a mouse click by adding a circle to that location. Circle colors
  // rotate through a set list of colors. A double click clears the dots and
  // resets the counter.
  // ---------------------------------------------------------------------------
