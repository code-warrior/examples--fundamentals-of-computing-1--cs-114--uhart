...
public class ClickDistance extends Application {
  ...
  // ---------------------------------------------------------------------------
  // Shows the distance between the origin (0, 0) and the point where the mouse
  // is clicked.
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  // Resets the end point of the line to the location of the mouse click event
  // and updates the distance displayed.
  // ---------------------------------------------------------------------------
